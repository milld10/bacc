...
\input{template/title_Thesis_TU_Graz}            %% include title page
...
\input{chapters/introduction}        %% this is a suggestion: you have to create this file on demand
\input{chapters/motivation}
\input{chapters/related_work}
\input{chapters/background}
\input{chapters/architecture}
\input{chapters/security_evaluation}
